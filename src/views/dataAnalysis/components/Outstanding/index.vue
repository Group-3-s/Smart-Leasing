<template>
  <div class="dialog-content">
    ...
    <div class="content-area">
      <!-- 根据当前选中的ID显示对应的内容 -->
      <div v-if="currentId === 1"><TuBiao /></div>
...
<script setup>
  ...
  import TuBiao from '/@/views/dataAnalysis/components/Outstanding/TuBiao.vue';
  import DataPage from '/@/views/dataAnalysis/components/Outstanding/DataPage.vue';
