...
<script setup>
  import { ref } from 'vue';
  import Chart from '/@/views/dataAnalysis/components/AccountingLedger/Chart .vue';
  import Dataset from '/@/views/dataAnalysis/components/AccountingLedger/Dataset .vue';
