...
<script setup>
  ...
  import TubiaoPage from '/@/views/dataAnalysis/components/investmentpromotion/Tubiao.vue';
  import DataPage from '/@/views/dataAnalysis/components/investmentpromotion/DataPage.vue';
