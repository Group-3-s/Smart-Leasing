...
<script setup>
  ...
  import TubiaoPage from '/@/views/dataAnalysis/components/LeaseLedger/TubiaoPage.vue';
  import DataPage from '/@/views/dataAnalysis/components/LeaseLedger/DataPage.vue';
